...
top_result_path = "../Data/Species_Search_Data/Top_Hits_Scans/Scanned_Results.csv"
scan_path = "../Data/Species_Search_Data/MSA_Scans_From_nhmmerscan/"
counter = 0
...
for record in SeqIO.parse(all_kap_sequence_path, "fasta"):
    ...
    for group in final_tuple:
        ...
        if (record.id == group[0]):
            ...
            print(group)
            with open("Species_Top_Hits.csv", "a") as file:
                file.write(group + '\n')
