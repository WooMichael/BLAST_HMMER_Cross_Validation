...
stream = os.popen('ls /root/16s-subunit-bacteria-hmm-search/Data/Species_Search_Data/MSA_Scans_From_nhmmerscan/')
output = stream.readlines()
msa_path = "/root/16s-subunit-bacteria-hmm-search/Data/Species_Search_Data/MSA_Scans_From_nhmmerscan/"
top_hit_output = "/root/16s-subunit-bacteria-hmm-search/Data/Species_Search_Data/Top_Hits_Scans/"
